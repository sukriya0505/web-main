...
export function FilterSidebar() {
  return (
    <div className="w-64 border-r p-4 h-screen">
      <h2 className="font-medium mb-4">Filter by</h2>
      ...
      <div className="space-y-6">
        ...
        <Button className="w-full bg-purple-500 hover:bg-purple-600">Apply</Button>
      </div>
    </div>
  )
}
